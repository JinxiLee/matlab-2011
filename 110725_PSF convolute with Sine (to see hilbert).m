...
sinefunction_convoluted_h=abs(hilbert(sinefunction_convoluted));
cosinefunction_convoluted_h=abs(hilbert(cosinefunction_convoluted));
plot(space_FD,sinefunction_convoluted_h,space_FD,cosinefunction_convoluted_h,space_FD,sinefunction_convoluted,space_FD,cosinefunction_convoluted);

...
thickness_temp=1.75E-6;
n_should=[1.3 1.5 1.6 1.7];

Starting_pixel_f_considered=225;
Ending_pixel_f_considered=375;
...
Data=importdata('111017_3000micros 500 mA_Red_Cross Edge 1.txt');
...
pixel_1=280;               % the end of upper (the larger peak)
...
dlmwrite('n.txt',n,'delimiter','\t','newline','pc');

dlmwrite('k.txt',k,'delimiter','\t','newline','pc');
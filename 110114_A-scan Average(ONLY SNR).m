...
data_array_all_1=importdata('D:\110117_ascan averge1.txt');

clear   data_array_1

data_array_1(1:fix(size(data_array_all_1,1)/averaging_factor),size(data_array_all_1,2))=0;

for j=1:fix(size(data_array_all_1,1)/averaging_factor)
data_array_1(j,:)=sum(data_array_all_1(1+(j-1)*averaging_factor:j*averaging_factor,:),1);
end

clear data_array_all_1

if size(data_array_1,1)>100
data_array_1=data_array_1(1:100,:);
end
...
data_array_all_2=importdata('D:\110117_ascan averge2.txt');

clear   data_array_2

data_array_2(1:fix(size(data_array_all_2,1)/averaging_factor),size(data_array_all_2,2))=0;

for j=1:fix(size(data_array_all_2,1)/averaging_factor)
data_array_2(j,:)=sum(data_array_all_2(1+(j-1)*averaging_factor:j*averaging_factor,:),1);
end

clear data_array_all_2

if size(data_array_2,1)>100
data_array_2=data_array_2(1:100,:);
end
...
data_array_all_3=importdata('D:\110117_ascan averge3.txt');

clear   data_array_3

data_array_3(1:fix(size(data_array_all_3,1)/averaging_factor),size(data_array_all_3,2))=0;

for j=1:fix(size(data_array_all_3,1)/averaging_factor)
data_array_3(j,:)=sum(data_array_all_3(1+(j-1)*averaging_factor:j*averaging_factor,:),1);
end

clear data_array_all_3

if size(data_array_3,1)>100
data_array_3=data_array_3(1:100,:);
end
...
data_array=[data_array_1;data_array_2;data_array_3];

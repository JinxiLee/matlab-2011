...
%Is_o=importdata('D:\PALC\average100\AC10V30Hz_20Hz_116um_100_1\Cut Data\s極光.txt');
...
%Ip_o=importdata('D:\PALC\average100\AC10V30Hz_20Hz_116um_100_1\Cut Data\p極光.txt');
...
Ip_sub=(Ip-CS_real/max(CS_real)*Ip_peakvalue*ratiop(j));  %this 0.9 can be critical...
...
Is_new_real=real(ifft(Is_f));

Ip_new=abs(ifft(Ip_f));

Ip_new_real=real(ifft(Ip_f));
...
Ip_sub=(Ip-CS_real/max(CS_real)*Ip_peakvalue*goodRatiop);  %this 0.9 can be critical...
...
dlmwrite('D:\Is_new.txt',Is_new,'delimiter','\t','newline','pc');
dlmwrite('D:\Ip_new.txt',Ip_new,'delimiter','\t','newline','pc');
dlmwrite('D:\Is_new_real.txt',Is_new_real,'delimiter','\t','newline','pc');
dlmwrite('D:\Ip_new_real.txt',Ip_new_real,'delimiter','\t','newline','pc');

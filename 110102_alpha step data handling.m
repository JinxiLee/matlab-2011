...
profile_original=importdata('D:\100-micron Grating alpha step IMG_1319.TXT');
...
lateral_position=lateral_position-360;
profile_sub=profile_sub-profile_sub(360);

plot(lateral_position,profile_sub);

Area_1_left=360;  %index
Area_1_right=385;  %index

Area_2_left=405;  %index
Area_2_right=435;  %index

Height_1=mean(profile_sub(Area_1_left:Area_1_right));
Height_2=mean(profile_sub(Area_2_left:Area_2_right));
Step_difference=Height_1-Height_2;

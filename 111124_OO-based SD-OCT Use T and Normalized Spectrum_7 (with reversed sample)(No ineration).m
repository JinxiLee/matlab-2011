...
% For Spectroscopy    
    ...
    for j=1:(Frequency_Considered_Max_Index-Frequency_Considered_Min_Index+1)
        ...
        r1_r=((n_temp+i*k_temp)-n1(index_now))./(n_temp+n1(index_now)+i*k_temp);    
        ...
        Spectrum_Temp=angle((r1+t1.*t1_r.*r2.*(d.^2))./r_BK7(index_now));                       %神說是cosine
        ...
        k(index_now)=k_temp(index);    %index1,index2=k,n  in situ saving all the solutions

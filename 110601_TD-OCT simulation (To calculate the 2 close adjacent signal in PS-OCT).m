...
axial_position=(150-50*center_wavelength):center_wavelength/4:(150+50*center_wavelength);       %micron
...
scanning_position=145:0.01:155;    %micron
...
interz=interz';
interz_hilbert=abs(hilbert(interz));
scanning_position=scanning_position';

%plot(scanning_position,log(interz_hilbert));
plot(scanning_position,interz,scanning_position,interz_hilbert);
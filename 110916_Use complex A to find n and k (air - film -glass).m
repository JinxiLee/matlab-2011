...
Signal=importdata('D:\110915\2Hz - Green 2\5');
Signal=Signal(:,1);
...
thickness_temp=0.000002:0.00000002:0.000003;
...
dlmwrite('D:\frequency.txt',frequency,'delimiter','\t','newline','pc');
dlmwrite('D:\n_final.txt',n_final,'delimiter','\t','newline','pc');
dlmwrite('D:\k_final.txt',k_final,'delimiter','\t','newline','pc');

...
Frequency=[0:Frequency_total/(length(Signal)-1):Frequency_total];%/2琌ㄓ
Frequency=Frequency';
...
% initial guesses:
        ...
        for j=1:(Frequency_Considered_Max_Index-Frequency_Considered_Min_Index+1)
            ...
            % Merit Function
            %Merit=((Spectrum_1_Temp-Spectrum_1(index_now)).^2)+((Spectrum_
            %2_Temp-Spectrum_2(index_now)).^2)+((Spectrum_3_Temp-Spectrum_3(index_now)).^2);

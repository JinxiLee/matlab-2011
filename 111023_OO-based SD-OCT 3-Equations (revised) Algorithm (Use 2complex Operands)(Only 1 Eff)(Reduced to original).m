...
% initial guesses:
    ...
    while (q <= Number_of_loop)                                                    % q: Loop 2, for Efficiency_1, Efficiency_2, Efficiency_3, Thickness, Thickness_0
        ...
        for j=1:(Frequency_Considered_Max_Index-Frequency_Considered_Min_Index+1)
            ...
            % Operand_2
            % Operand_3
            Spectrum_2_Temp_Env=abs((t1.*t1_r.*r2.*(d.^2))./(r1));
            Spectrum_2_Temp_Phase=angle((t1.*t1_r.*r2.*(d.^2))./(r1));
            % Merit Function
            ...
            Merit=((Spectrum_2_Temp_Env-abs(Spectrum_3(index_now)/Spectrum_2(index_now))).^2)+((Spectrum_2_Temp_Phase-angle(Spectrum_3(index_now)/Spectrum_2(index_now))).^2);
            ...
            Error_Total_2_Temp= Error_Total_2_Temp+((Spectrum_2_Temp_Env(index_1(index_2_temp), index_2)-abs(Spectrum_3(index_now)/Spectrum_2(index_now))).^2);
            Error_Total_2_2_Temp= Error_Total_2_2_Temp+((Spectrum_2_Temp_Phase(index_1(index_2_temp), index_2)-angle(Spectrum_3(index_now)/Spectrum_2(index_now))).^2);
            %Error_Total_Temp=Error_Total_1_Temp+Error_Total_2_Temp+Error_Total_3_Temp;
            Error_Total_Temp=Error_Total_2_Temp+Error_Total_2_2_Temp;
        end

...
% initial guesses:
    ...
    while (q < Number_of_loop)                                                    % q: Loop 2, for Efficiency_1, Efficiency_2, Efficiency_3, Thickness, Thickness_0
        ...
        for j=1:(Frequency_Considered_Max_Index-Frequency_Considered_Min_Index+1)
            ...
            Error_Total_2_Temp= Error_Total_2_Temp+(abs(Spectrum_2_Temp(index_1(index_2_temp), index_2)-Spectrum_2(index_now)).^2);
            Error_Total_3_Temp= Error_Total_3_Temp+(abs(Spectrum_3_Temp(index_1(index_2_temp), index_2)-Spectrum_3(index_now)).^2);

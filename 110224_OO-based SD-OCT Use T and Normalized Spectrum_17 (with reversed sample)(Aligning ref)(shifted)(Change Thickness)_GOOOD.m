...
Position_Error_Temp=0.022*1E-6;%[0.019:0.001:0.024]*1E-6;%[0.02:0.0003:0.023]*1E-6;0.022
n_should=1.65;
delta_n=0.08;
...
Data=importdata(sprintf('TEST%i.txt',202));
Data_Reference=importdata(sprintf('TEST%i.txt',51));
...
for q=1:length(Position_Error_Temp)
Ratio=Ratio_Temp;    
Thickness=Thickness_Temp;
Position_Error=Position_Error_Temp(q);

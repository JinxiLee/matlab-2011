...
%%
        ...
        %plot(Wavelength_micron(Wavelength_micron(:,K)<0.6,K),n_final(Wavelength_micron(:,K)<0.6,K),Wavelength_micron(Wavelength_micron(:,K)<0.6,K),k_final(Wavelength_micron(:,K)<0.6,K));
...
dlmwrite('Wavelength_micron.txt',Wavelength_micron(:,K),'delimiter','\t','newline','pc');
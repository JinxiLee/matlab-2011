...
% initial guesses:
    ...
    while (q <= Number_of_loop)                                                    % q: Loop 2, for Efficiency_1, Efficiency_2, Efficiency_3, Thickness, Thickness_0
        ...
        Error_Total_abs_Temp=0;
        Error_Total_phase_Temp=0;
        for j=1:(Frequency_Considered_Max_Index-Frequency_Considered_Min_Index+1)
            ...
            Merit=((A_temp_abs-abs(Spectrum_3(index_now)/Spectrum_2(index_now))).^2)+((A_temp_phase-angle(Spectrum_3(index_now)/Spectrum_2(index_now))).^2);
            ...
            Error_Total_abs_Temp= Error_Total_abs_Temp+(A_temp_abs(index_1(index_2_temp), index_2)-abs(Spectrum_3(index_now)/Spectrum_2(index_now))).^2;
            Error_Total_phase_Temp= Error_Total_phase_Temp+(A_temp_phase(index_1(index_2_temp), index_2)-angle(Spectrum_3(index_now)/Spectrum_2(index_now))).^2;
            %Error_Total_Temp=Error_Total_1_Temp+Error_Total_2_Temp+Error_Total_3_Temp;
            Error_Total_Temp=Error_Total_abs_Temp+Error_Total_phase_Temp;
        end

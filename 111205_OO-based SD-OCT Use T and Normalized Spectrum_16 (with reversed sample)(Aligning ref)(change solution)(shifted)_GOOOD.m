...
Position_Error=0.022*1E-6;%[0.019:0.001:0.024]*1E-6;%[0.02:0.0003:0.023]*1E-6;
n_should=1.65;
delta_n=0.1;
...
for q=1:length(Position_Error)
Spectrum_Additional=exp(i*4*pi.*Frequency/C.*(Position_Error(q)));

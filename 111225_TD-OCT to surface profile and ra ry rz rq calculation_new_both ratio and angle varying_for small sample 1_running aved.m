...
data_Bscan=importdata('D:\111224\111224_SMALL SAMPLE 1000micron ave10.txt');
ref_Bscan=importdata('D:\111224\111224_mirror 1000micron ave10.txt');
data_Bscan=data_Bscan(:,(size(data_Bscan,2)-round(length_lateral/lateral_step)+1):end);
ref_Bscan=ref_Bscan(:,(size(ref_Bscan,2)-round(length_lateral/lateral_step)+1):end);
...
profile_calibrated=profile-profile_ref*ratio(b);
    ...
    profile_sub=smooth(profile_sub,5);

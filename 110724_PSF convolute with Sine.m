...
perturbation=cos(2*pi*(space_FD(j)+period2/8)/period2);
cosinefunction(j)=100*cos(2*pi*(space_FD(j)+period/8)/period).*(10+perturbation);
sinefunction(j)=100*sin(2*pi*(space_FD(j)+period/8)/period).*(10+perturbation);
end
end
